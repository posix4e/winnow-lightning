...
1. In Setup, enter the regtest Bitcoin peer's P2P address, such as `192.168.1.8:18444`, and start the node. Confirm that Wallet shows a regtest funding address.
