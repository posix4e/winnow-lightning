...
//
// Generation: 2026-09-15T00:00:00Z, 977 peers re-verified offline from the
// winnow-census artifact of 2026-09-15, recorded tip 967111.
extension NetworkParams {
    static let generatedMainnetFallbackPeers: [PeerEndpoint] = [
        ...
        PeerEndpoint(host: "114.77.129.116", port: 8333),  // /Satoshi:31.1.0/
        PeerEndpoint(host: "115.131.26.224", port: 8333),  // /Satoshi:29.3.0/Knots:20260507/
        ...
        PeerEndpoint(host: "134.101.155.28", port: 8333),  // /Satoshi:31.0.0/
        ...
        PeerEndpoint(host: "141.98.219.12", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "172.220.244.249", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "173.235.239.153", port: 8333),  // /Satoshi:29.3.0/Knots:20260507/
        ...
        PeerEndpoint(host: "174.94.26.220", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "176.198.157.242", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "178.114.171.133", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "178.192.96.140", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "179.26.180.6", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "190.171.120.135", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "2.88.242.134", port: 8333),  // /Satoshi:30.2.0/
        ...
        PeerEndpoint(host: "217.208.140.9", port: 8333),  // /Satoshi:31.1.0/
        PeerEndpoint(host: "217.211.131.194", port: 8333),  // /Satoshi:31.1.0/
        PeerEndpoint(host: "217.230.47.140", port: 8333),  // /Satoshi:31.1.0/
        PeerEndpoint(host: "217.232.226.140", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "223.204.74.49", port: 8333),  // /Satoshi:31.1.0(@Nakhonsithammarat,TH)/
        ...
        PeerEndpoint(host: "24.162.30.72", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "37.27.70.253", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "46.142.157.249", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "5.56.248.2", port: 8333),  // /Satoshi:30.0.0/
        ...
        PeerEndpoint(host: "58.11.120.101", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "62.91.147.66", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "65.21.22.173", port: 8333),  // /btcwire:0.5.0/btcd:0.25.0/
        ...
        PeerEndpoint(host: "77.10.208.226", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "77.188.211.53", port: 8333),  // /Satoshi:31.0.0/
        ...
        PeerEndpoint(host: "77.98.161.67", port: 8333),  // /Satoshi:31.0.0/
        ...
        PeerEndpoint(host: "78.35.199.151", port: 8333),  // /Satoshi:31.1.0/
        PeerEndpoint(host: "78.50.201.13", port: 8333),  // /Satoshi:31.0.0/
        PeerEndpoint(host: "78.54.150.218", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "79.112.130.146", port: 8333),  // /Satoshi:31.0.0/
        PeerEndpoint(host: "79.116.68.42", port: 8333),  // /Satoshi:31.1.0/
        PeerEndpoint(host: "79.117.19.58", port: 8333),  // /Satoshi:31.0.0/
        PeerEndpoint(host: "79.135.106.89", port: 8333),  // /Satoshi:26.0.0/
        ...
        PeerEndpoint(host: "79.209.56.86", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "79.245.49.47", port: 8333),  // /Satoshi:31.0.0/
        PeerEndpoint(host: "79.246.73.39", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "82.66.171.153", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "83.50.192.144", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "84.155.4.251", port: 8333),  // /Satoshi:29.1.0/
        PeerEndpoint(host: "84.159.57.64", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "84.174.112.135", port: 8333),  // /Satoshi:31.1.0/
        PeerEndpoint(host: "84.178.239.243", port: 8333),  // /Satoshi:29.1.0/
        PeerEndpoint(host: "84.18.229.2", port: 8333),  // /Satoshi:31.1.0/
        PeerEndpoint(host: "84.183.6.170", port: 8333),  // /Satoshi:31.0.0/
        ...
        PeerEndpoint(host: "84.39.76.111", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "85.16.192.40", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "87.172.151.79", port: 8333),  // /Satoshi:30.0.0/
        ...
        PeerEndpoint(host: "87.79.190.227", port: 8333),  // /Satoshi:31.1.0/
        PeerEndpoint(host: "88.0.25.242", port: 8333),  // /Satoshi:31.1.0/
        PeerEndpoint(host: "88.119.167.62", port: 8333),  // /Satoshi:30.2.0/
        PeerEndpoint(host: "88.130.119.192", port: 8333),  // /Satoshi:31.0.0/
        ...
        PeerEndpoint(host: "89.147.108.149", port: 8333),  // /Satoshi:29.3.0(Barcelona Bitcoin Only community node)/Knots:20260507/
        PeerEndpoint(host: "89.164.130.71", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "89.247.151.141", port: 8333),  // /Satoshi:31.0.0/
        PeerEndpoint(host: "89.35.197.146", port: 8333),  // /Satoshi:31.1.0/
        PeerEndpoint(host: "89.56.241.78", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "91.248.187.219", port: 8333),  // /Satoshi:31.0.0/
        ...
        PeerEndpoint(host: "92.116.3.136", port: 8333),  // /Satoshi:29.1.0/
        ...
        PeerEndpoint(host: "92.27.11.82", port: 8333),  // /Satoshi:31.1.0(1)/
        ...
        PeerEndpoint(host: "93.130.180.5", port: 8333),  // /Satoshi:31.0.0/
        PeerEndpoint(host: "93.133.44.93", port: 8333),  // /Satoshi:30.2.0/
        ...
        PeerEndpoint(host: "93.232.125.142", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "95.117.111.86", port: 8333),  // /Satoshi:30.2.0/
        ...
        PeerEndpoint(host: "95.33.101.31", port: 8333),  // /Satoshi:31.1.0/
        ...
        PeerEndpoint(host: "99.119.117.136", port: 8333),  // /Satoshi:29.2.0/
...
// Source: winnowwallet/census@915d0f538332b888d63fbb1b85ac8049aea218c5:census/peers.json
// Source SHA256: 836d908f559be6781c8feb653d9da6fe682b24be611fb48c9d65b65f8cb89dd5
// Source commit: 915d0f538332b888d63fbb1b85ac8049aea218c5
// Observation date: 2026-09-15; generated: 2026-09-15T17:35:03Z
